...
var style_LapakGIScomBatas_Kecamatan_BIG_PPBW_0 = function(feature, resolution){
    ...
    var labelText = "";
    size = 0;
    var labelFont = "10.725px \'Mongolian Baiti\', sans-serif";
    ...
    if (value > 0.000000 && value <= 530.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 530.000000 && value <= 2000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 10000.000000 && value <= 40000.000000) {
            style = [ new ol.style.Style({
